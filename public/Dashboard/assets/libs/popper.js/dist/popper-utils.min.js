...
function t(b, d, e = !1) {
    ...
    e && 'HTML' === d.nodeName && (k.top = f(k.top, 0), k.left = f(k.left, 0));
    let q = r({
        top: j.top - k.top - o,
...
function v(c) {
    const d = c.nodeName;
    return 'BODY' === d || 'HTML' === d ? !1 : !('fixed' !== a(c, 'position')) || v(b(c))
}
...
function x(a, d, e, f, g = !1) {
    ...
    if ('viewport' === f) h = u(i, g);
        ...
        let e;
        'scrollParent' === f ? (e = c(b(d)), 'BODY' === e.nodeName && (e = a.ownerDocument.documentElement)) : 'window' === f ? e = a.ownerDocument.documentElement : e = f;
        const j = t(e, i, g);
        if ('HTML' === e.nodeName && !v(i)) {
            ...
            h.top += j.top - j.marginTop, h.bottom = a + j.top, h.left += j.left - j.marginLeft, h.right = b + j.left
        } else h = j
    }
...
function W(a, b) {
    Object.keys(b).forEach((c) => {
        let d = ''; - 1 !== ['width', 'height', 'top', 'right', 'bottom', 'left'].indexOf(c) && R(b[c]) && (d = 'px'), a.style[c] = b[c] + d
    })
}
