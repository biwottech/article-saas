...
function c(e) {
    ...
    return n && 'BODY' !== n && 'HTML' !== n ? -1 !== ['TD', 'TABLE'].indexOf(o.nodeName) && 'static' === s(o, 'position') ? c(o) : o : e ? e.ownerDocument.documentElement : document.documentElement
}
...
function T(e, t, o = !1) {
    ...
    o && 'HTML' === t.nodeName && (d.top = n(d.top, 0), d.left = n(d.left, 0));
    let u = L({
        top: p.top - d.top - m,
...
function N(e) {
    const t = e.nodeName;
    return 'BODY' === t || 'HTML' === t ? !1 : !('fixed' !== s(e, 'position')) || N(f(e))
}
...
function P(e, t, o, n, i = !1) {
    ...
    if ('viewport' === n) r = D(p, i);
        ...
        if ('HTML' === o.nodeName && !N(p)) {
            ...
            r.top += d.top - d.marginTop, r.bottom = e + d.top, r.left += d.left - d.marginLeft, r.right = t + d.left
        } else r = d
    }
...
function G(e, t, o, n) {
    ...
    r.addEventListener(t, o, {
        passive: !0
    }), i || G(a(r.parentNode), t, o, n), n.push(r)
}

function z(e, t, o, n) {
    o.updateBound = n, q(e).addEventListener('resize', o.updateBound, {
        passive: !0
    });
    const i = a(e);
    return G(i, 'scroll', o.updateBound, o.scrollParents), o.scrollElement = i, o.eventsEnabled = !0, o
}
...
function _(e, t) {
    return q(e).removeEventListener('resize', t.updateBound), t.scrollParents.forEach((e) => {
...
function J(e, t) {
    Object.keys(t).forEach((o) => {
        let n = ''; - 1 !== ['width', 'height', 'top', 'right', 'bottom', 'left'].indexOf(o) && Q(t[o]) && (n = 'px'), e.style[o] = t[o] + n
    })
}
...
function te(e, t) {
    ...
    const {
        ...
        popper: p
    } = e.offsets, d = F(e.instance.modifiers, (e) => 'applyStyle' === e.name).gpuAcceleration;
    ...
    const s = void 0 === d ? t.gpuAcceleration : d,
        ...
        g = K('transform');
    let b, w;
    if (w = 'bottom' == h ? -a.height + m.bottom : m.top, b = 'right' == u ? -a.width + m.right : m.left, s && g) l[g] = `translate3d(${b}px, ${w}px, 0)`, l[h] = 0, l[u] = 0, l.willChange = 'transform';
    else {
    ...
    return e.attributes = O({}, y, e.attributes), e.styles = O({}, l, e.styles), e.arrowStyles = O({}, e.offsets.arrow, e.arrowStyles), e
}
...
function fe(e, t) {
    ...
    return p.forEach((d, s) => {
        ...
        (m || b || y) && (e.flipped = !0, (m || b) && (n = p[s + 1]), y && (r = ie(r)), e.placement = n + (r ? '-' + r : ''), e.offsets.popper = O({}, e.offsets.popper, M(e.instance.popper, e.offsets.reference, e.placement)), e = R(e.instance.modifiers, e, 'flip'))
    }), e
}
...
function me(e, t, o, n) {
    ...
    return f = f.map((e, n) => {
        ...
        let p = !1;
        return e.reduce((e, t) => '' === e[e.length - 1] && -1 !== ['+', '-'].indexOf(t) ? (e[e.length - 1] = t, p = !0, e) : p ? (e[e.length - 1] += t, p = !1, e) : e.concat(t), []).map((e) => le(e, i, t, o))
    }), f.forEach((e, t) => {
        e.forEach((o, n) => {
            Q(o) && (i[t] += o * ('-' === e[n - 1] ? -1 : 1))
        })
...
function he(e, {
    ...
    let p;
    return p = Q(+t) ? [+t, 0] : me(t, n, i, r), 'left' === r ? (n.top += p[0], n.left -= p[1]) : 'right' === r ? (n.top += p[0], n.left += p[1]) : 'top' === r ? (n.left += p[0], n.top -= p[1]) : 'bottom' === r && (n.left += p[0], n.top += p[1]), e.popper = n, e
}
...
class Ee {
    constructor(e, t, o = {}) {
        this.scheduleUpdate = () => requestAnimationFrame(this.update), this.update = p(this.update.bind(this)), this.options = O({}, Ee.Defaults, o), this.state = {
            isDestroyed: !1,
            isCreated: !1,
            scrollParents: []
        }, this.reference = e && e.jquery ? e[0] : e, this.popper = t && t.jquery ? t[0] : t, this.options.modifiers = {}, Object.keys(O({}, Ee.Defaults.modifiers, o.modifiers)).forEach((e) => {
            this.options.modifiers[e] = O({}, Ee.Defaults.modifiers[e] || {}, o.modifiers ? o.modifiers[e] : {})
