 ...
 */
(function(a, b) {
    'object' == typeof exports && 'undefined' != typeof module ? b(exports) : 'function' == typeof define && define.amd ? define(['exports'], b) : b(a.PopperUtils = {})
})(this, function(a) {
    'use strict';
    ...
    function f(a) {
        ...
        for (var c = e(10) ? document.body : null, d = a.offsetParent; d === c && a.nextElementSibling;) d = (a = a.nextElementSibling).offsetParent;
        var g = d && d.nodeName;
        return g && 'BODY' !== g && 'HTML' !== g ? -1 !== ['TD', 'TABLE'].indexOf(d.nodeName) && 'static' === b(d, 'position') ? f(d) : d : a ? a.ownerDocument.documentElement : document.documentElement
    }
    ...
    function r(a, c) {
        ...
        f && 'HTML' === c.nodeName && (j.top = R(j.top, 0), j.left = R(j.left, 0));
        var r = p({
            top: i.top - j.top - n,
    ...
    function t(a) {
        var d = a.nodeName;
        return 'BODY' === d || 'HTML' === d ? !1 : !('fixed' !== b(a, 'position')) || t(c(a))
    }
    ...
    function v(a, b, e, f) {
        ...
        if ('viewport' === f) h = s(i, g);
            ...
            var k;
            'scrollParent' === f ? (k = d(c(b)), 'BODY' === k.nodeName && (k = a.ownerDocument.documentElement)) : 'window' === f ? k = a.ownerDocument.documentElement : k = f;
            var l = r(k, i, g);
            if ('HTML' === k.nodeName && !t(i)) {
                var m = o(),
                    n = m.height,
                    p = m.width;
                h.top += l.top - l.marginTop, h.bottom = n + l.top, h.left += l.left - l.marginLeft, h.right = p + l.left
            } else h = l
        }
    ...
    function M(a, b, c) {
        ...
        return d.forEach(function(a) {
            ...
            a.enabled && G(c) && (b.offsets.popper = p(b.offsets.popper), b.offsets.reference = p(b.offsets.reference), b = c(b, a))
        }), b
    }
