...
function h(b) {
    ...
    for (var c = g(10) ? document.body : null, d = b.offsetParent; d === c && b.nextElementSibling;) d = (b = b.nextElementSibling).offsetParent;
    var e = d && d.nodeName;
    return e && 'BODY' !== e && 'HTML' !== e ? -1 !== ['TD', 'TABLE'].indexOf(d.nodeName) && 'static' === a(d, 'position') ? h(d) : d : b ? b.ownerDocument.documentElement : document.documentElement
}
...
function u(b, d) {
    ...
    f && 'HTML' === d.nodeName && (k.top = e(k.top, 0), k.left = e(k.left, 0));
    var q = s({
        top: j.top - k.top - o,
...
function w(c) {
    var d = c.nodeName;
    return 'BODY' === d || 'HTML' === d ? !1 : !('fixed' !== a(c, 'position')) || w(b(c))
}
...
function y(a, d, e, f) {
    ...
    if ('viewport' === f) h = v(i, g);
        ...
        var j;
        'scrollParent' === f ? (j = c(b(d)), 'BODY' === j.nodeName && (j = a.ownerDocument.documentElement)) : 'window' === f ? j = a.ownerDocument.documentElement : j = f;
        var k = u(j, i, g);
...
function V(a, b, c) {
    ...
    return d.forEach(function(a) {
        ...
        a.enabled && P(c) && (b.offsets.popper = s(b.offsets.popper), b.offsets.reference = s(b.offsets.reference), b = c(b, a))
    }), b
}
...
function Y(a, b, d, e) {
    ...
    g.addEventListener(b, d, {
        passive: !0
    }), f || Y(c(g.parentNode), b, d, e), e.push(g)
}

function Z(a, b, d, e) {
    d.updateBound = e, T(a).addEventListener('resize', d.updateBound, {
        passive: !0
    });
    var f = c(a);
