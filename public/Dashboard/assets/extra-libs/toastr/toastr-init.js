$(function() {
    ...
    // Slide Down Success / Slide Up
    $('#slide-toast-success').on('click', function() {
    ...
    // Slide Down Error / Slide Up
    $('#slide-toast-error').on('click', function() {
        toastr.error('Refresh the Page and Try again!', 'Something Went Wrong!', {
            "showMethod": "slideDown",
            "hideMethod": "slideUp",
            timeOut: 2000
        });
