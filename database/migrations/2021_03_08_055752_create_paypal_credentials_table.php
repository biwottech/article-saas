...
class CreatePaypalCredentialsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('paypal_credentials', function (Blueprint $table) {
            ...
            $table->text('PAYPAL_ACCOUNT_ID')->nullable();
        ...
        PaypalCredential::create([
            ...
            'PAYPAL_CLIENT_ID' => 'AVQw3_9w0X0gsf5hqL6TKS2H2uIF4bSXXs0fYLvZtNNOnY4XQN5qvtT_RFVJEtkaHyTXTUI-u-Vzyjlt',

            'PAYPAL_SECRET_ID' => 'EHOqktIt7Sq-R8PXVwMddwIH6K3rbQogz-dKHCfAyCOSTQT0JYs13utE76xEqCZ0qEVfCERg1IaK_RIf',

            'PAYPAL_ACCOUNT_ID' => 'sb-0ftsv5212827@business.example.com',
