                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <img style="width: 100%;" class="mb-4" src="{{ asset('Articles/FeatureImages/'.$article->feature_image) }}" alt="Article Image">
                            @else
                            <img style="width: 100%;" class="mb-4" src="{{ asset('Dashboard/assets/images/placeholder.png') }}" alt="Article Image">
                            @endif
                            {!! $article->content !!}
                        </div>
                        <div class="card-body">
