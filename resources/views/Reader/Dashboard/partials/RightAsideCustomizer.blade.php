...
<span class="user-img"> <img src="{{ asset('Dashboard/assets/images/users/5.jpg')}}" alt="user" class="rounded-circle"> <span class="profile-status offline pull-right"></span> </span>
<span class="mail-contnet">
...
<span class="user-img"> <img src="{{ asset('Dashboard/assets/images/users/6.jpg')}}" alt="user" class="rounded-circle"> <span class="profile-status offline pull-right"></span> </span>
<span class="mail-contnet">
...
<span class="user-img"> <img src="{{ asset('Dashboard/assets/images/users/7.jpg')}}" alt="user" class="rounded-circle"> <span class="profile-status offline pull-right"></span> </span>
<span class="mail-contnet">
...
<span class="user-img"> <img src="{{ asset('Dashboard/assets/images/users/8.jpg')}}" alt="user" class="rounded-circle"> <span class="profile-status offline pull-right"></span> </span>
<span class="mail-contnet">
...
<div class="sl-item">
<div class="sl-left"> <img class="rounded-circle" alt="user" src="{{ asset('Dashboard/assets/images/users/2.jpg')}}"> </div>
<div class="sl-right">
...
<div class="sl-item">
<div class="sl-left"> <img class="rounded-circle" alt="user" src="{{ asset('Dashboard/assets/images/users/1.jpg')}}"> </div>
<div class="sl-right">
...
<div class="sl-item">
<div class="sl-left"> <img class="rounded-circle" alt="user" src="{{ asset('Dashboard/assets/images/users/4.jpg')}}"> </div>
<div class="sl-right">
<div class="font-medium">Go to the Doctor <span class="sl-date">5 minutes ago</span></div>
<div class="desc">Contrary to popular belief</div>
</div>
...
<div class="sl-item">
<div class="sl-left"> <img class="rounded-circle" alt="user" src="{{ asset('Dashboard/assets/images/users/6.jpg')}}"> </div>
<div class="sl-right">
<div><a href="javascript:void(0)">Stephen</a> <span class="sl-date">5 minutes ago</span></div>
<div class="desc">Approve meeting with tiger</div>
</div>
