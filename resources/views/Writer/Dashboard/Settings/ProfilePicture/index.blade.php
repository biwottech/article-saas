                        ...
                        <div class="d-flex justify-content-center">
                            <div class="col-sm-12 col-md-3 col-lg-3">
                                ...
                                <div class="text-center mb-3">
                                    <button formaction="{{ route('WriterSaveProfilePicture') }}" type="submit" class="btn btn-info btn-rounded">Save Image</button>
                                    @if(!is_null(Auth::user()->user_image))
                                    <button formaction="{{ route('WriterRemoveProfilePicture') }}" type="submit" class="btn btn-danger btn-rounded">Remove Image</button>
                                    @endif
                                </div>
