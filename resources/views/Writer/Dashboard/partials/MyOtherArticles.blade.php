@if($articles = Student::OtherArticles($article->id))
                ...
                <div class="col-sm-12 col-md-4 col-lg-2 mx-auto">
                    <div class="card mb-2">
                        <div class="view overlay">
                            <a href="{{ route('WriterReadArticle',$related->id ) }}">
                        ...
                        <div class="card-body p-3">
                            ...
                            <a href="{{ route('WriterReadArticle',$related->id ) }}" class="btn btn-info btn-rounded waves-effect waves-light">Read More</a>
                        </div>
                    </div>
                </div>
            </div>
