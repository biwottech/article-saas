                            ...
                            <tbody>
                                ...
                                <tr class="text-center">
                                    ...
                                    <td>
                                        ...
                                        @else
                                        <a href="{{ route('WriterJoinCompetetion',$competetion->id) }}" class="btn-sm btn waves-effect waves-light btn-rounded btn-primary">
                                            <i class="fas fa-user-plus"></i>
                                        </a>
                                        @endif
                                    </td>
                                    <td>
                                        @if(Writer::HasJoinedCompetetion(Auth::user()->id,$competetion->id))
                                        <span class="badge badge-info p-1">
                                            {{ __('JOINED') }}
                                        </span>
                                        @else
