                    ...
                    <div class="alert alert-info text-center">
                        <div class="card bg-transparent">
                            <div class="card-header bg-transparent">
                                <h3>Submitted Articles Information</h3>
                            </div>
                            <div class="card-body">
                                <div class="row d-flex">
                                    ...
                                    <div class="col-sm-12 col-lg-3 col-md-3">
                                        ...
                                        <h4 class="card-title mt-4">
                                            Published
                                            <strong>
                                                {{ Competetion::CountSubmittedPublishedArticles($competetion->id)}}
                                            </strong>
                                        </h4>
                                    </div>
                                    <!--******************************-->
                                    ...
                                    <div class="col-sm-12 col-lg-3 col-md-3">
                                        ...
                                        <h4 class="card-title mt-4">
                                            Archived
                                            <strong>
                                                {{ Competetion::CountSubmittedArchivedArticles($competetion->id)}}
                                            </strong>
                                        </h4>
                                    </div>
                                    <!--******************************-->
                                    ...
                                    <div class="col-sm-12 col-lg-3 col-md-3">
                                        ...
                                        <h4 class="card-title mt-4">
                                            Banned
                                            <strong>
                                                {{ Competetion::CountSubmittedBannedArticles($competetion->id)}}
                                            </strong>
                                        </h4>
                                    </div>
                                    <!--******************************-->
