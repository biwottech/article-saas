                ...
                <div class="col-12">
                    ...
                    <div class="alert alert-info mb-5">
                        <div class="card bg-transparent mb-0">
                            <div class="card-body">
                                <h3 class="text-info"><i class="fa fa-portrait"></i> {{ $student->name }} Profile Picture</h3>
                                <!--******************************-->
                                <!--******************************-->
                                <!--******************************-->
                    ...
                    <form method="POST" enctype="multipart/form-data">
                        ...
                        <div class="d-flex justify-content-center">
                            <div class="col-sm-12 col-md-3 col-lg-3">
                                <div class="imgUp">
                                    @if(!is_null($student->user_image))
                                    <div class="imagePreview" style="background-image: url({{ asset('Users/profile_pictures/'.$student->user_image)}});"></div>
                                    @else
                                ...
                                <div class="text-center mb-3">
                                    <button formaction="{{ route('AdminUpdateStudentProfilePicture',$student->id) }}" type="submit" class="btn btn-info btn-rounded">Save Image</button>
                                    @if(!is_null($student->user_image))
                                    <button formaction="{{ route('AdminRemoveStudentProfilePicture',$student->id) }}" type="submit" class="btn btn-danger btn-rounded">Remove Image</button>
                                    @endif
                                </div>
