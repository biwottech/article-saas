                ...
                <div class="col-12">
                    ...
                    <div class="alert alert-info mb-5">
                        <div class="card bg-transparent mb-0">
                            <div class="card-body">
                                <h3 class="text-info"><i class="fa fa-user-cog"></i> {{ $student->name }} Subscriptions</h3>
                                <!--******************************-->
                                <!--******************************-->
                                <!--******************************-->
                                <strong class="mb-3 mt-5">Here you can View , Update & Delete Student Subscriptions.</strong>
                                <!--******************************-->
                                <!--******************************-->
                                <!--******************************-->
                            </div>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td align="center">
                                        ...
                                        <form method="POST" action="{{ route('AdminResumeStudentSubscription',$subscription->id) }}">
                                            @csrf
                                        ...
                                        @else
                                        <form method="POST" action="{{ route('AdminCancelStudentSubscription',$subscription->id) }}">
                                            @csrf
                                    ...
                                    <!--******************************-->
                                    <td align="center">
                                        <form method="POST" action="{{ route('AdminDeleteStudentSubscription',$subscription->id) }}">
                                            @csrf
