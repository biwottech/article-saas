                    ...
                    <div class="alert alert-info text-center">
                        <div class="card bg-transparent">
                            ...
                            <div class="card-body">
                                <div class="row d-flex">
                                    ...
                                    <div class="col-sm-12 col-lg-3 col-md-3">
                                        ...
                                        <h4 class="card-title mt-4">
                                            Total Articles
                                            <strong>
                                                {{ Student::CountArticles($student->id) }}
                                            </strong>
                                        </h4>
                                    </div>
                                    <!--******************************-->
                                    ...
                                    <div class="col-sm-12 col-lg-3 col-md-3">
                                        ...
                                        <h4 class="card-title mt-4">
                                            Published Articles
                                            <strong>
                                                {{ Student::CountPublishedArticles($student->id) }}
                                            </strong>
                                        </h4>
                                    </div>
                                    <!--******************************-->
                                    ...
                                    <div class="col-sm-12 col-lg-3 col-md-3">
                                        ...
                                        <h4 class="card-title mt-4">
                                            Archived Articles
                                            <strong>
                                                {{ Student::CountArchivedArticles($student->id) }}
                                            </strong>
                                        </h4>
                                    </div>
                                    <!--******************************-->
                                    ...
                                    <div class="col-sm-12 col-lg-3 col-md-3">
                                        ...
                                        <h4 class="card-title mt-4">
                                            Banned Articles
                                            <strong>
                                                {{ Student::CountBannedArticles($student->id) }}
                                            </strong>
                                        </h4>
                                    </div>
                                    <!--******************************-->
                                ...
                                <!--******************************-->
                                <!--******************************-->
                                <!--begin::Go Back To Student Button-->
                                <a href="{{ route('AdminViewStudent',$student->id) }}" class="btn waves-effect waves-light btn-rounded btn-info mt-2"> <i class="fas fa-long-arrow-alt-left"></i> Go to Student</a>
                                <!--end::Go Back To Student Button-->
                                <!--******************************-->
                                <!--******************************-->
                                <!--******************************-->
                            </div>
                                ...
                                <ul class="navbar-nav mr-auto">
                                    ...
                                    <li class="nav-item dropdown">
                                        ...
                                        <div class="dropdown-menu">
                                            <a class="dropdown-item" href="{{ route('AdminViewStudentArticles',['id' => $student->id,'page' => request('page') , 'status' => request('status') , 'visibility' => request('visibility')   ,'show' => 5]) }}"> 5 Results
                                            </a>
                                            @for($i=5;$i < 51; $i++) @if ($i % 10==0) <a class="dropdown-item" href="{{ route('AdminViewStudentArticles',['id' => $student->id,'page' => request('page') , 'status' => request('status') , 'visibility' => request('visibility')   ,'show' => $i]) }}">{{ $i }} Results
                                                </a>
                                                @endif
                                                @endfor
                                        </div>
                                    ...
                                    <li class="nav-item dropdown">
                                        ...
                                        <div class="dropdown-menu">
                                            <a class="dropdown-item" href="{{ route('AdminViewStudentArticles',['id' => $student->id,'page' => request('page') , 'show' => request('show') ,
                                    ...
                                    <li class="nav-item dropdown">
                                        ...
                                        <div class="dropdown-menu">
                                            <a class="dropdown-item" href="{{ route('AdminViewStudentArticles',['id' => $student->id,'page' => request('page') , 'show' => request('show') ,'visibility' => 'published']) }}">Published</a>
                                            <a class="dropdown-item" href="{{ route('AdminViewStudentArticles',['id' => $student->id,'page' => request('page'), 'show' => request('show') ,'visibility' => 'archived']) }}">Archived</a>
                                        </div>
                                    </li>
                                    <!-- Dropdown -->
                                    <li class="nav-item">
                                        <a class="nav-link" href="{{ route('AdminViewStudentArticles',$student->id)}}">
                                            Reset Filters
                                        </a>
                                    </li>
                                </ul>
                                <form class="form-inline my-2 my-lg-0" action="{{ route('AdminViewStudentArticles',$student->id)}}">
