                    ...
                    <form method="POST" enctype="multipart/form-data">
                        ...
                        <div class="d-flex justify-content-center">
                            <div class="col-sm-12 col-md-3 col-lg-3">
                                <div class="imgUp">
                                    @if(!is_null($teacher->user_image))
                                    <div class="imagePreview" style="background-image: url({{ asset('Users/profile_pictures/'.$teacher->user_image)}});"></div>
                                    @else
                                ...
                                <div class="text-center mb-3">
                                    <button formaction="{{ route('AdminUpdateTeacherProfilePicture',$teacher->id) }}" type="submit" class="btn btn-info btn-rounded">Save Image</button>
                                    @if(!is_null($teacher->user_image))
                                    <button formaction="{{ route('AdminRemoveTeacherProfilePicture',$teacher->id) }}" type="submit" class="btn btn-danger btn-rounded">Remove Image</button>
                                    @endif
                                </div>
