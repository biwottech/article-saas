                            ...
                            <ul class="navbar-nav mr-auto">
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu">
                                        <a class="dropdown-item" href="{{ route('AdminCompetetionsDashboard',['page' => request('page') , 'result_status' => request('result_status') , 'status' => request('status')  ,'show' => 5]) }}"> 5 Results
                                        </a>
                                        @for($i=5;$i < 51; $i++) @if ($i % 10==0) <a class="dropdown-item" href="{{ route('AdminCompetetionsDashboard',['page' => request('page') , 'result_status' => request('result_status') , 'status' => request('status')  ,'show' => $i]) }}">{{ $i }} Results
                                            </a>
                                            @endif
                                            @endfor
                                    </div>
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu">
                                        <a class="dropdown-item" href="{{ route('AdminCompetetionsDashboard',['page' => request('page') ,'result_status' => request('result_status') , 'show' => request('show') ,'status' => 'initializing']) }}">Initializing</a>
                                        <a class="dropdown-item" href="{{ route('AdminCompetetionsDashboard',['page' => request('page') ,'result_status' => request('result_status') , 'show' => request('show') ,'status' => 'started']) }}">Started</a>
                                        <a class="dropdown-item" href="{{ route('AdminCompetetionsDashboard',['page' => request('page') ,'result_status' => request('result_status') , 'show' => request('show') ,'status' => 'paused']) }}">Paused</a>
                                        <a class="dropdown-item" href="{{ route('AdminCompetetionsDashboard',['page' => request('page') ,'result_status' => request('result_status') , 'show' => request('show') ,'status' => 'ended']) }}">Ended</a>
                                    </div>
                                </li>
                                <!-- Dropdown -->
                                <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu">
                                        <a class="dropdown-item" href="{{ route('AdminCompetetionsDashboard',['page' => request('page'), 'show' => request('show') , 'status' => request('status') ,'result_status' => 'pending']) }}">Pending Results</a>
                                        <a class="dropdown-item" href="{{ route('AdminCompetetionsDashboard',['page' => request('page'), 'show' => request('show') , 'status' => request('status') ,'result_status' => 'announced']) }}">Announced Results</a>
                                    </div>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ route('AdminCompetetionsDashboard') }}">
                                        Reset Filters
                                    </a>
                                </li>
                            </ul>
                            <form class="form-inline my-2 my-lg-0" action="{{ route('AdminCompetetionsDashboard') }}">
                            ...
                            <tbody>
                                ...
                                <tr class="text-center">
                                    ...
                                    <td>
                                        ...
                                        <a href="#" class="btn-sm btn waves-effect waves-light btn-rounded btn-primary disabled">
                                            <i class="fas fa-edit"></i>
                                        </a>
                                        @else
                                        <a href="{{ route('EditCompetetion',$competetion->id) }}" class="btn-sm btn waves-effect waves-light btn-rounded btn-primary">
                                            <i class="fas fa-edit"></i>
                                        </a>
                                        @endif
                                    </td>
