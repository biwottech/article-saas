    ...
    <div class="page-wrapper">
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-12">
                    ...
                    <div class="alert alert-info mb-5">
                        <div class="card bg-transparent mb-0">
                            <div class="card-body">
                                <h3 class="text-info"><i class="fa fa-clock"></i> Competetion Information</h3>
                                <!--******************************-->
                                <!--******************************-->
                                <!--******************************-->
                                <strong class="mb-3 mt-5">You can Set the Competetion Information here.</strong>
                                <!--******************************-->
                                <!--******************************-->
                                <!--******************************-->
                            </div>
                ...
                <!--******************************-->
                <div class="col-12">
                    <form method="POST" action="{{ route('SaveCompetetionInfo') }}">
                        @csrf
                        <div class="col mb-3">
                            <label for="name">Competetion Name</label>
                            <input type="text" class="form-control @error('name') is-invalid @enderror" value="{{ old('name') }}" id="name" name="name" placeholder="Competetion Name">
                        ...
                        <div class="col mb-3">
                            <label for="status">Competetion Status</label>
                            ...
                            <small class="text-dark">Set Status for the Competetion.</small>
                            @error('status')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                        ...
                        <div class="col mb-3">
                            ...
                            <input type="date" class="form-control @error('starting_date') is-invalid @enderror" value="{{ old('starting_date') }}" id="starting_date" name="starting_date" placeholder="Starting Date">
                        ...
                        <div class="col mb-3">
                            ...
                            <input type="date" class="form-control @error('ending_date') is-invalid @enderror" value="{{ old('ending_date') }}" id="ending_date" name="ending_date" placeholder="Ending Date">
                        ...
                        <div class="col mb-3">
                            ...
                            <textarea class="form-control @error('description') is-invalid @enderror" id="description" name="description" placeholder="Write Some Description">{{ old('description') }}</textarea>
                        ...
                        <div class="col mb-3">
                            ...
                            <textarea class="form-control @error('guides') is-invalid @enderror" id="guides" name="guides" placeholder="Write Some Guide Lines">{{ old('guides') }}</textarea>
