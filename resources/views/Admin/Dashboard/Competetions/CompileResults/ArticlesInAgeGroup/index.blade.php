                                ...
                                <div class="row d-flex">
                                    ...
                                    <div class="col-sm-12 col-lg-3 col-md-3">
                                        ...
                                        <h4 class="card-title mt-4">
                                            Total
                                            <strong>
                                                {{ Competetion::CountArticlesInAgeGroup($competetion->id,$group->id)}}
                                            </strong>
                                        </h4>
                                    </div>
                                    <!--******************************-->
                                    ...
                                    <div class="col-sm-12 col-lg-3 col-md-3">
                                        ...
                                        <h4 class="card-title mt-4">
                                            Published
                                            <strong>
                                                {{ Competetion::CountPublishedArticlesInAgeGroup($competetion->id,$group->id)}}
                                            </strong>
                                        </h4>
                                    </div>
                                    <!--******************************-->
                                    ...
                                    <div class="col-sm-12 col-lg-3 col-md-3">
                                        ...
                                        <h4 class="card-title mt-4">
                                            Archived
                                            <strong>
                                                {{ Competetion::CountArchivedArticlesInAgeGroup($competetion->id,$group->id)}}
                                            </strong>
                                        </h4>
                                    </div>
                                    <!--******************************-->
                                    ...
                                    <div class="col-sm-12 col-lg-3 col-md-3">
                                        ...
                                        <h4 class="card-title mt-4">
                                            Banned
                                            <strong>
                                                {{ Competetion::CountBannedArticlesInAgeGroup($competetion->id,$group->id)}}
                                            </strong>
                                        </h4>
                                    </div>
                                    <!--******************************-->
                            ...
                            <ul class="navbar-nav mr-auto">
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu">
                                        <a class="dropdown-item" href="{{ route('AdminViewCompetetionArticlesInAgeGroup',['competetion' => $competetion->id,'group' => $group->id ,'page' => request('page') , 'status' => request('status') , 'visibility' => request('visibility')   ,'show' => 5]) }}"> 5 Results
                                        </a>
                                        @for($i=5;$i < 51; $i++) @if ($i % 10==0) <a class="dropdown-item" href="{{ route('AdminViewCompetetionArticlesInAgeGroup',['competetion' => $competetion->id,'group' => $group->id ,'page' => request('page') , 'status' => request('status') , 'visibility' => request('visibility')   ,'show' => $i]) }}">{{ $i }} Results
                                            </a>
                                            @endif
                                            @endfor
                                    </div>
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu">
                                        <a class="dropdown-item" href="{{ route('AdminViewCompetetionArticlesInAgeGroup',['competetion' => $competetion->id , 'group' => $group->id,'page' => request('page') , 'show' => request('show') ,
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu">
                                        <a class="dropdown-item" href="{{ route('AdminViewCompetetionArticlesInAgeGroup',['competetion' => $competetion->id , 'group' => $group->id,'page' => request('page') , 'show' => request('show') ,'visibility' => 'published']) }}">Published</a>
                                        <a class="dropdown-item" href="{{ route('AdminViewCompetetionArticlesInAgeGroup',['competetion' => $competetion->id , 'group' => $group->id,'page' => request('page'), 'show' => request('show') ,'visibility' => 'archived']) }}">Archived</a>
                                    </div>
                                </li>
                                <!-- Dropdown -->
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ route('AdminViewCompetetionArticlesInAgeGroup',['competetion' => $competetion->id,
                                'group' => $group->id ])}}">
                                        Reset Filters
                                    </a>
                                </li>
                            </ul>
                            <form class="form-inline my-2 my-lg-0" action="{{ route('AdminViewCompetetionArticlesInAgeGroup',['competetion' => $competetion->id,
                                'group' => $group->id ])}}">
