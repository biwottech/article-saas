                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <img style="width: 100%;" class="mb-4" src="{{ asset('Articles/FeatureImages/'.$article->feature_image) }}" alt="Card image cap">
                            @else
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12 d-flex">
                                            ...
                                            <div class="col flex-row d-flex justify-content-center align-items-center">
                                                <div class="detials">
                                                    <p> <a href="{{ route('AdminEditArticle',$article->id) }}" class="btn-light"><i class="fas fa-edit"></i> Edit Article</a></p>
                                                </div>
                                            </div>
                                            <!--end::Edit Article-->
                                            <!--begin::Edit Article-->
                                            <div class="col flex-row d-flex justify-content-center align-items-center">
                                                <div class="detials">
                                                    <p> <a href="{{ route('AdminViewStudent',$article->user_id) }}" class="btn-light"><i class="fas fa-user"></i> View Author</a></p>
                                                </div>
                                            </div>
                                            <!--end::Edit Article-->
                                            <div class="col flex-row d-flex justify-content-center align-items-center">
                                            ...
                                            <div class="card mb-2">
                                                <div class="view overlay">
                                                    <a href="{{ route('AdminReadArticle',$related->id) }}">
                                                        @if(!is_null($article->feature_image))
                                                        <img style="width: 100%; height: 100px;" class="card-img-top" src="{{ asset('Articles/FeatureImages/'.$article->feature_image) }}" alt="Card image cap">
                                                        @else
