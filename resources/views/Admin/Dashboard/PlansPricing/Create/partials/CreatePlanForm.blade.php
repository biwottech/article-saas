<div class="col-12">
    <form method="POST" action="{{ route('AdminSavePlan') }}">
        @csrf
        <!--**************************************-->
        <!--**************************************-->
        <!--**************************************-->
        <div class="form-group row">
            <div class="col-sm-12 col-lg-4 col-md-4">
                <h4>Plan Pricing & Description</h4>
            </div>
        </div>
        <!--**************************************-->
        <!--**************************************-->
        ...
        <div class="form-group row">
            <div class="col-sm-12 col-lg-4 col-md-4 mb-3">
                ...
                <input type="text" class="form-control @error('name') is-invalid @enderror" value="{{ old('name') }}" id="name" name="name" placeholder="Plan Name Here" required>
                @error('name')
            ...
            <div class="col-sm-12 col-lg-4 col-md-4 mb-3">
                ...
                <input type="description" class="form-control @error('description') is-invalid @enderror" value="{{ old('description') }}" id="description" name="description" placeholder="Plan Description Here" required>
                @error('description')
                <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
                </span>
            ...
            <div class="col-sm-12 col-lg-4 col-md-4 mb-3">
                ...
                <input type="text" class="form-control @error('price') is-invalid @enderror" value="{{ old('price') ? old('price') : 0 }}" id="price" name="price" placeholder="Plan Price Here" required>
        ...
        <div class="form-group row">
            <div class="col-sm-12 col-lg-3 col-md-3 mb-3">
                ...
                <input type="text" class="form-control @error('signup_fee') is-invalid @enderror" value="{{ old('signup_fee') ? old('signup_fee') : 0 }}" id="signup_fee" name="signup_fee" placeholder="Plan SignUp Fee Here" required>
                <small class="text-muted">
            ...
            <div class="col-sm-12 col-lg-3 col-md-3 mb-3">
                ...
                <select class="form-control @error('grace_period') is-invalid @enderror" name="grace_period">
                    @for($i=1;$i<366;$i++) <option value="{{ $i }}">
                        {{ $i.__(' Days')}}
                        </option>
                        @endfor
                </select>
